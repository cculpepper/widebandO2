...
#define uart0GetStringBlock(c,d) uartGetStringBlock(uart0Data,c,d)
#define uart0PutString(c) uartPutString(uart0Data,c)
#define uart0PutStringBlock(c) uartPutStringBlock(uart0Data,c)
#define uart0PutCharBlock(c) uartPutCharBlock(uart0Data,c)
